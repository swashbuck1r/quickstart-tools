...
The [.cloudbees/workflows/workflow.yaml](/tree/main/.cloudbees/workflows) workflow definition shows how to use CloudBees to build the Dockerfile definition into a container image and publish it to a container registry.
